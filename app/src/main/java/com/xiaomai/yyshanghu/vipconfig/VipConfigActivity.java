package com.xiaomai.yyshanghu.vipconfig;
...
import com.xiaomai.yyshanghu.adapter.Adapter_AddVip;
...
import com.xiaomai.yyshanghu.utils.SwipeItemLayout;
...
public class VipConfigActivity extends BaseActivity {
    ...
    private int total,limit,position_w;
        ...
        RetrofitClient.getInstance().getApi(token).getPageWhiteList(requestBody)
                ...
                .subscribe(new Consumer<AddVipBean>() {
                               ...
                               public void accept(AddVipBean addVipBean) throws Exception {
                                   ...
                                   }else if(addVipBean.getCode()==-10 || addVipBean.getMsg().equals("您的账户已在其他设备上登录")){
                                       signOutDialog(VipConfigActivity.this);
